...
<div class="table-scroll" tabindex="0" role="region" aria-label="Choosing a rhyme type"><table><thead><tr><th scope="col">Need</th><th scope="col">Try</th><th scope="col">Watch for</th></tr></thead><tbody><tr><td>Clear hook closure</td><td>Perfect end rhyme</td><td>Predictable wording</td></tr><tr><td>Conversational verse</td><td>Slant rhyme or assonance</td><td>Connections too faint to hear</td></tr><tr><td>Dense rhythmic momentum</td><td>Multisyllabic or multi-word rhyme</td><td>Syntax bent around the rhyme</td></tr><tr><td>One line to stand apart</td><td>Break or postpone the pattern</td><td>Accidental-sounding inconsistency</td></tr></tbody></table></div>
...
<div class="table-scroll" tabindex="0" role="region" aria-label="Rhyme patterns by section"><table><thead><tr><th scope="col">Section job</th><th scope="col">Possible pattern</th><th scope="col">Reason</th></tr></thead><tbody><tr><td>Set the scene</td><td>ABCB with light internal echoes</td><td>Leaves room for detail</td></tr><tr><td>Build pressure</td><td>AABB plus a repeated internal chain</td><td>Increases recurrence</td></tr><tr><td>Deliver the hook</td><td>Short perfect-rhyme pair or repeated title</td><td>Creates a clear landing</td></tr><tr><td>Change perspective</td><td>Break the established rhyme for one line</td><td>Makes the turn audible</td></tr></tbody></table></div>
...
<div class="table-scroll" tabindex="0" role="region" aria-label="Voice memo development plan"><table><thead><tr><th scope="col">Recording</th><th scope="col">Role</th><th scope="col">Next action</th></tr></thead><tbody><tr><td>Paper Crown 01</td><td>Hook melody</td><td>Choose key and comfortable range</td></tr><tr><td>Paper Crown 02</td><td>Verse lyric sketch</td><td>Transcribe first eight lines</td></tr><tr><td>Paper Crown 03</td><td>Harmony option</td><td>Compare after lead take</td></tr></tbody></table></div>
...
<div class="table-scroll" tabindex="0" role="region" aria-label="Demo completion checklist"><table><thead><tr><th scope="col">Must prove</th><th scope="col">Can wait</th></tr></thead><tbody><tr><td>Complete form</td><td>Final ad-libs</td></tr><tr><td>Intelligible lead</td><td>Detailed automation</td></tr><tr><td>Stable timing reference</td><td>Release mastering</td></tr><tr><td>Export that plays through</td><td>Every harmony idea</td></tr></tbody></table></div>
